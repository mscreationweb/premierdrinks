...
export default function Deal() {
    return (
        <>
            {/* Deal Section */}
            <section className="deal-section" style={{ backgroundImage: 'url(./assets/images/allimg/Jackfruit.webp)' }} >
                ...
                <div className="auto-container">
                    <div className="content-box" style={{backgroundColor:'transparent'}} >
